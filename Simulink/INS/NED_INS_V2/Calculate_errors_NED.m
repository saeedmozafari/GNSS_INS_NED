...
delta_r_eb_n1 = (est_L_b - true_L_b) * (R_N + true_h_b);
delta_r_eb_n2 = (est_lambda_b - true_lambda_b) * (R_E + true_h_b) *...
    cos(true_L_b);
delta_r_eb_n3 = -(est_h_b - true_h_b);

delta_r_eb_n = [delta_r_eb_n1;delta_r_eb_n2;delta_r_eb_n3];
